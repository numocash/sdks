...
export type GetUniswapV3PoolDataReturnType = UniswapV3PoolData;

export const getUniswapV3PoolData = <TChain extends Chain | undefined,>(
  client: Client<Transport, TChain>,
  { pool, ...request }: GetUniswapV3PoolDataParameters,
): Promise<GetUniswapV3PoolDataReturnType> =>
  Promise.all([
    readContract(client, {
    ...
    uniswapV3Pool: pool,
    sqrtPrice: createPrice(pool.token1, pool.token0, data[0].poolData[0], Q96),
