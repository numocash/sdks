...
import { writePanopticCollateralWithdraw } from "./writePanopticCollateralWithdraw.js";
...
test("WithwritePanopticCollateralWithdraw", async () => {
  const hash = await writePanopticCollateralWithdraw(walletClient, {
    args: {
