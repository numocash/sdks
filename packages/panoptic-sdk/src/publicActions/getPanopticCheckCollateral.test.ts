...
import { getPanopticCheckCollateral } from "./getPanopticCheckCollateral.js";
...
test("get check collateral", async () => {
  const collateralCheck = await getPanopticCheckCollateral(publicClient, {
    positions: [position],
